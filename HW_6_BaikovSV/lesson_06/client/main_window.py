...
from lesson_06.client.main_window_conv import Ui_MainClientWindow
from lesson_06.client.add_contact import AddContactDialog
from lesson_06.client.del_contact import DelContactDialog
