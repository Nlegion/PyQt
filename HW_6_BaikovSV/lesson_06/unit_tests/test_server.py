...
from lesson_06.common.variables import TIME, ACTION, PRESENCE, USER, ACCOUNT_NAME, RESPONSE, ERROR
from lesson_06.my_testing_codes.old_files.server import process_client_message
