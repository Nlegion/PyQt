...
from lesson_06.common.variables import ACTION, PRESENCE, TIME, USER, ACCOUNT_NAME, \
...
from lesson_06.common.errors import ReqFieldMissingError, ServerError, IncorrectDataReceivedError

from lesson_06.logs.configs.config_client_log import LOGGER as CLIENT_LOGGER  # Инициализация клиентского логера
from lesson_06.common.metaclasses import ClientMaker
from lesson_06.my_testing_codes.old_files.client_database import ClientDatabase
