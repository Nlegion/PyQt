...
from lesson_07.common.variables import ACTION, PRESENCE, TIME, USER, ACCOUNT_NAME, \
...
from lesson_07.common.errors import ReqFieldMissingError, ServerError, IncorrectDataReceivedError

from lesson_07.logs.configs.config_client_log import LOGGER as CLIENT_LOGGER  # Инициализация клиентского логера
from lesson_07.common.metaclasses import ClientMaker
from lesson_07.my_testing_codes.old_files.client_database import ClientDatabase
