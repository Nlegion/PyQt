...
from lesson_07.common.variables import TIME, ACTION, PRESENCE, USER, ACCOUNT_NAME, RESPONSE, ERROR
from lesson_07.my_testing_codes.old_files.server import process_client_message
