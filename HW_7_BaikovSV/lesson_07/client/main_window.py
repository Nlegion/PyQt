...
from lesson_07.client.main_window_conv import Ui_MainClientWindow
from lesson_07.client.add_contact import AddContactDialog
from lesson_07.client.del_contact import DelContactDialog
